...
public class CSVToSQLTsyFailed {
    ...
    public static void main(String[] args) throws Exception{
        ...
        try {
            ...
            // Chemin des fichiers
            String csvFilePath = "src/main/resources/bureauvote-1000.csv"; // Fichier CSV d'entrée
            String outputSqlFilePath = "src/main/resources/bureauvote-1000-script.sql"; // Fichier SQL généré
            String errorFilePath = "src/main/resources/bureauvote-1000-echoue.csv"; // Fichier CSV des erreurs
            ...
            while ((line = br.readLine()) != null) {
                ...
                try{
                    ...
                    String updateQuery = String.format(
                            "UPDATE personne SET estverifie = 1, presenceListeCeni = '1' WHERE id = '%s';",
                            id
                    );
